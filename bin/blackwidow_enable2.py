#!/usr/bin/env python2
"""
    Send the magic data to the Blackwidow keyboard, so that the special
    keys work.

    Note that this depends on pyusb (pip install pyusb) and it requires
    python2 currently.
...
PRODUCT_ID = 0x010d  # above id is wrong for my keyboard
